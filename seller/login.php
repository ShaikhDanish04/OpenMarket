...
if (isset($_POST['register_submit'])) {
    ...
    if ($query_response === TRUE) {
        $status = '' .
            ...
            '        <p class="text-info font-weight-bold mb-2">Your Shop is Registed Successfully</p>' .
        ...
        <div class="user-input w-100 ">
            <form action="" id="register_form" data-ajax="false" class="collapse" method="post">
                ...
                <div class="input-box mb-3">
                    ...
                    <small class="text-muted">*Enter your name or shop name</small>
                </div>
                ...
                <div class="input-box mb-3">
                    ...
                    <small class="text-muted">*Select type of shop you have</small>
                </div>
                <div class="input-box mb-3">
