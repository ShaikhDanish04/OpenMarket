...
<div class="side-bar">
    <div class="display">
        ...
        <p class="user-name">Danish Shaikh</p>
        <p class="small font-weight-bold mb-0">ID : 1</p>
    </div>
    <div class="menu-list">
        <a href="" class="list-item"><i class="fa fa-tachometer"></i> Dashboard</a>
        <a href="" class="list-item"><i class="fa fa-cart-plus"></i> Add New Product</a>
...
<div class="content-view">
    <div class="action-bar">
        ...
        <div class="end">
            <button class="btn menu-toggle"><i class="fa fa-ellipsis-v"></i></button>
        </div>
    </div>
    <div class="screen">
